  ...
  const NotfoundComponent = ({ setIsNotFound }) => {
    ...
    return (
      ...
      <DrawerHeader />
        <Box>
          <Routes>
          <Route path="/home" element={<UserHome sendUrllist={receiveUrllist} />} />
          <Route path="/ReportDevice" element={<UserDeviceTree sendUrllist={receiveUrllist} />} />
          <Route path="/ReportApplication" element={<ApplicationUser sendUrllist={receiveUrllist} />} />
          <Route path="/ReportInfrastructure" element={<InfrastructureUser sendUrllist={receiveUrllist} />} />
                <Route
                  path="/*"
