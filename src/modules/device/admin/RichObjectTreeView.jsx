...
export default function RichObjectTreeView() {
  ...
  const [plantId, setPlantId] = useState("plant101");
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "http://localhost:8081/device/admin/getTree/plant101",
          {
            method: "GET",
            headers: {
                ...
                <center>
                  ...
                  >
                    ...
                    <Select
                      ...
                      displayEmpty
                      inputProps={{ "aria-label": "Select Issue Category" }}
                    >
                          ...
                          {isEditingCapacity ? (
                            <>
                              ...
                              <Button
                                variant="contained"
                                color="secondary"
                                onClick={() => handleCancelNameEdit("Capacity")}
                              >
                                Cancel
                              </Button>
                            </>
                          ...
                          {isEditingCatagory ? (
                            <>
                              ...
                              <Button
                                variant="contained"
                                color="secondary"
                                onClick={() => handleCancelNameEdit("Catagory")}
                              >
                                Cancel
                              </Button>
                            </>
